...
class TestLoadEnabledApis:
    ...
    def test_loads_from_config_file(
        ...
        from main.orchestration.pipeline import load_enabled_apis
    ...
    def test_returns_default_for_missing_file(self, temp_dir: str) -> None:
    ...
    def test_returns_empty_for_no_enabled(self, temp_dir: str) -> None:
...
class TestFilterEnabledProvidersForKeys:
    ...
    def test_filters_providers_missing_keys(self) -> None:
    ...
    def test_keeps_providers_with_keys(self) -> None:
...
class TestUpdateWorkStatus:
    ...
    def test_updates_with_extra_data(self, work_dir_structure: dict[str, str]) -> None:
...
class TestBuildIndexRow:
    ...
    def test_builds_row_dict(self, sample_search_result: Any) -> None:
        """Test building index row dictionary."""
        from main.data.index import build_index_row
