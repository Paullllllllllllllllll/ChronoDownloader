...
class TestSearchResult:
    ...
    def test_basic_creation(self) -> None:
        ...
        sr = SearchResult(provider="Internet Archive", title="Test Title")
...
class TestConvertToSearchResult:
    ...
    def test_basic_conversion(self) -> None:
        ...
        data = {"title": "Test Title", "creator": "John Smith", "identifier": "test123"}
    ...
    def test_url_fallbacks(self) -> None:
        ...
        assert (
            convert_to_searchresult("P", data1).iiif_manifest == "https://manifest.json"
        )
...
class TestQuotaDeferredException:
    ...
    def test_with_reset_time(self) -> None:
        ...
        reset = datetime(2024, 1, 1, 12, 0, 0, tzinfo=UTC)
    ...
    def test_with_custom_message(self) -> None:
        ...
        exc = QuotaDeferredException("provider", message="Custom error message")
