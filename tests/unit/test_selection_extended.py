...
class TestScoreCandidate:
    ...
    def test_iiif_manifest_boost(self) -> None:
    ...
    def test_item_url_boost(self) -> None:
    ...
    def test_total_equals_score_plus_boost(self) -> None:
...
class TestAttachScores:
    ...
    def test_attaches_matching_dict(self) -> None:
    ...
    def test_preserves_existing_raw_data(self) -> None:
...
class TestGetMaxResultsForProvider:
    ...
    @patch("main.orchestration.selection.get_provider_setting", return_value="10")
    def test_returns_configured_value(self, mock_setting: MagicMock) -> None:
        assert get_max_results_for_provider("ia") == 10

    @patch("main.orchestration.selection.get_provider_setting", return_value=None)
    def test_returns_default_when_not_configured(self, mock_setting: MagicMock) -> None:
        assert get_max_results_for_provider("ia") == 5

    @patch("main.orchestration.selection.get_provider_setting", return_value="invalid")
    def test_returns_default_on_invalid_value(self, mock_setting: MagicMock) -> None:
        assert get_max_results_for_provider("ia") == 5

    @patch("main.orchestration.selection.get_provider_setting", return_value=None)
    def test_custom_default(self, mock_setting: MagicMock) -> None:
...
class TestGetMaxParallelSearches:
    ...
    @patch("main.orchestration.selection.get_config", return_value={})
...
class TestSearchSingleProvider:
    ...
    @patch("main.orchestration.selection.get_max_results_for_provider", return_value=5)
    def test_handles_search_exception(self, mock_max: MagicMock) -> None:
    ...
    @patch("main.orchestration.selection.get_max_results_for_provider", return_value=5)
    def test_handles_empty_results(self, mock_max: MagicMock) -> None:
        search_fn = MagicMock(return_value=[])
        provider_tuple = ("ia", search_fn, MagicMock(), "Internet Archive")
        pkey, pname, candidates = _search_single_provider(
...
class TestCollectCandidatesExhaustive:
    ...
    @patch("main.orchestration.selection.get_max_results_for_provider", return_value=5)
    def test_searches_all_providers(self, mock_max: MagicMock) -> None:
    ...
    @patch("main.orchestration.selection.get_max_results_for_provider", return_value=5)
    def test_handles_empty_results_from_provider(self, mock_max: MagicMock) -> None:
        p1 = ("ia", MagicMock(return_value=[]), MagicMock(), "Internet Archive")
        candidates = _collect_candidates_exhaustive([p1], "Test", None, 0.2, 5)
        assert candidates == []

    @patch("main.orchestration.selection.get_max_results_for_provider", return_value=5)
    def test_handles_provider_exception(self, mock_max: MagicMock) -> None:
...
class TestCollectCandidatesAll:
    ...
    @patch("main.orchestration.selection._get_max_parallel_searches", return_value=1)
    @patch("main.orchestration.selection._collect_candidates_exhaustive")
    def test_uses_sequential_when_parallel_is_1(
        self, mock_seq: MagicMock, mock_parallel: MagicMock
    ) -> None:
    ...
    @patch("main.orchestration.selection._get_max_parallel_searches", return_value=1)
    @patch("main.orchestration.selection._collect_candidates_exhaustive")
    def test_uses_sequential_for_single_provider(
        self, mock_seq: MagicMock, mock_parallel: MagicMock
    ) -> None:
        mock_seq.return_value = []
...
class TestSelectBestCandidateExtended:
    ...
    @patch("main.orchestration.selection.get_min_title_score", return_value=85)
    def test_selects_highest_scoring_candidate(self, mock_min: MagicMock) -> None:
    ...
    @patch("main.orchestration.selection.get_min_title_score", return_value=85)
    def test_respects_provider_priority(self, mock_min: MagicMock) -> None:
        sr1 = _make_sr(title="Test", provider_key="ia", source_id="1")
    ...
    @patch("main.orchestration.selection.get_min_title_score", return_value=50)
    def test_per_provider_threshold(self, mock_min: MagicMock) -> None:
