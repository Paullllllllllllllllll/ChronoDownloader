...
class TestDetectModeAndParseArgs:
    ...
    def test_cli_mode_from_config(self, sample_config: dict[str, Any]) -> None:
    ...
    def test_force_cli_with_flag(self, sample_config: dict[str, Any]) -> None:
    ...
    def test_config_path_override(self, sample_config: dict[str, Any], temp_dir: str) -> None:
    ...
    def test_config_load_failure(self) -> None:
        ...
        with patch("main.ui.mode.get_config", side_effect=Exception("Config error")):
            with pytest.raises(SystemExit):
                _detect_mode_and_parse_args(parser_factory, "test_script")
    
    def test_default_interactive_when_missing(self, sample_config: dict[str, Any]) -> None:
...
class TestRunWithModeDetection:
    ...
    def test_returns_mode_detection_results(self, sample_config: dict[str, Any]) -> None:
...
class TestGetGeneralConfig:
    ...
    def test_returns_general_section(self, sample_config: dict[str, Any]) -> None:
    ...
    def test_handles_none_general_section(self) -> None:
