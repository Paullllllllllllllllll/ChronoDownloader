...
class TestCircuitBreaker:
    ...
    def test_record_failure_reopens_half_open_circuit(self) -> None:
    ...
    def test_allow_request_transitions_to_half_open(self) -> None:
    ...
    def test_time_until_retry_returns_remaining_time(self) -> None:
...
class TestRateLimiter:
    ...
    def test_init_with_zero_interval(self) -> None:
    ...
    def test_wait_adds_jitter(self) -> None:
...
class TestCircuitBreakerFunctions:
    ...
    def reset_circuit_breakers(self) -> Generator[None, None, None]:
    ...
    def test_get_circuit_breaker_returns_none_for_none(self) -> None:
    ...
    def test_get_circuit_breaker_returns_none_if_disabled(self) -> None:
...
class TestRateLimiterFunctions:
    ...
    @pytest.fixture(autouse=True)
    def reset_rate_limiters(self) -> Generator[None, None, None]:
    ...
    def test_get_provider_for_url_identifies_providers(self) -> None:
    ...
    def test_get_rate_limiter_creates_limiter(self) -> None:
...
class TestSessionManagement:
    ...
    @pytest.fixture(autouse=True)
    def reset_session(self) -> Generator[None, None, None]:
    ...
    def test_build_session_returns_session(self) -> None:
...
class TestMakeRequest:
    ...
    def test_make_request_returns_none_when_circuit_open(self) -> None:
        """make_request returns None when circuit breaker is open."""
        from api.core.network import CircuitBreaker, CircuitState, make_request
    ...
    def test_make_request_returns_json_for_json_response(self) -> None:
        ...
        with patch("api.core.network.get_session") as mock_session:
            ...
            with (
                ...
                patch("api.core.network.get_rate_limiter", return_value=None),
            ):
                result = make_request("https://example.com/api")

                assert result == {"key": "value"}

    def test_make_request_returns_text_for_html(self) -> None:
    ...
    def test_make_request_returns_bytes_for_binary(self) -> None:
    ...
    def test_make_request_returns_none_for_404(self) -> None:
    ...
    def test_make_request_records_success_to_circuit_breaker(self) -> None:
        """make_request records success to circuit breaker."""
        from api.core.network import CircuitBreaker, make_request
    ...
    def test_make_request_handles_timeout(self) -> None:
    ...
    def test_make_request_handles_json_decode_error(self) -> None:
...
class TestProviderHostMap:
    ...
    def test_provider_host_map_has_known_providers(self) -> None:
    ...
    def test_provider_host_map_hosts_are_tuples(self) -> None:
        """PROVIDER_HOST_MAP values are tuples of hostnames."""
        from api.core.network import PROVIDER_HOST_MAP

        for _provider, hosts in PROVIDER_HOST_MAP.items():
