...
class TestInteractiveWorkflowModeOptions:
    ...
    def test_mode_options_include_direct_iiif(
...
class TestConfigureDirectIIIFMode:
    ...
    def test_single_valid_url(
        self, mock_ui_class: MagicMock, mock_general: MagicMock, mock_config: MagicMock
    ) -> None:
    ...
    @patch("main.ui.interactive.get_general_config")
    @patch("main.ui.interactive.ConsoleUI")
    def test_invalid_url_rejected_then_accepted(
        self, mock_ui_class: MagicMock, mock_general: MagicMock, mock_config: MagicMock
    ) -> None:
        ...
        mock_ui_class.prompt_input.side_effect = [
            ...
            "https://gallica.bnf.fr/iiif/ark:/12148/bpt6k123/manifest.json",  # valid
            "",  # empty to finish
            "",  # empty name
        ]
