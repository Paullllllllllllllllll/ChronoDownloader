...
class TestDownloadConfigurationIIIFFields:
    ...
    def test_mode_includes_direct_iiif(self) -> None:
...
class TestInteractiveWorkflowModeOptions:
    ...
    @patch('main.ui.interactive.get_config')
    @patch('main.ui.interactive.get_general_config')
    def test_mode_options_include_direct_iiif(self, mock_general: MagicMock, mock_config: MagicMock) -> None:
    ...
    @patch('main.ui.interactive.get_config')
    @patch('main.ui.interactive.get_general_config')
    def test_mode_options_has_four_entries(self, mock_general: MagicMock, mock_config: MagicMock) -> None:
...
class TestConfigureDirectIIIFMode:
    ...
    @patch('main.ui.interactive.get_config')
    @patch('main.ui.interactive.get_general_config')
    @patch('main.ui.interactive.ConsoleUI')
    def test_single_valid_url(self, mock_ui_class: MagicMock, mock_general: MagicMock, mock_config: MagicMock) -> None:
    ...
    @patch('main.ui.interactive.get_general_config')
    @patch('main.ui.interactive.ConsoleUI')
    def test_url_with_custom_name(self, mock_ui_class: MagicMock, mock_general: MagicMock, mock_config: MagicMock) -> None:
    ...
    @patch('main.ui.interactive.get_general_config')
    @patch('main.ui.interactive.ConsoleUI')
    def test_invalid_url_rejected_then_accepted(self, mock_ui_class: MagicMock, mock_general: MagicMock, mock_config: MagicMock) -> None:
