...
class TestComputeWorkId:
    ...
    def test_different_creator_different_id(self) -> None:
    ...
    def test_none_creator_handled(self) -> None:
...
class TestCheckWorkStatus:
    ...
    def test_skip_completed_with_pending_status(self, temp_dir: str) -> None:
    ...
    def test_skip_if_has_objects_with_files(self, temp_dir: str) -> None:
    ...
    def test_skip_if_has_objects_empty_dir(self, temp_dir: str) -> None:
    ...
    def test_nonexistent_work_dir(self, temp_dir: str) -> None:
    ...
    def test_uses_config_resume_mode(self, temp_dir: str) -> None:
        """Test uses resume mode from config when not specified."""
        work_dir = os.path.join(temp_dir, "test_work")
        os.makedirs(work_dir)

        with patch("main.data.work.get_resume_mode", return_value="reprocess_all"):
...
class TestUpdateWorkStatus:
    ...
    def test_adds_download_info(self, temp_dir: str) -> None:
    ...
    def test_handles_missing_file(self, temp_dir: str) -> None:
...
class TestCreateWorkJson:
    ...
    def test_custom_status(self, temp_dir: str) -> None:
