...
class TestExtractImageServiceBasesV2:
    ...
    def test_extracts_service_ids_from_v2(self, sample_iiif_manifest_v2):
    ...
    def test_extracts_from_resource_id_fallback(self):
    ...
    def test_skips_canvas_without_images(self):
        manifest = {
            "sequences": [{
                "canvases": [
                    {"images": []},
    ...
    def test_deduplicates_service_bases(self):
        manifest = {
            "sequences": [{
                "canvases": [
    ...
    def test_uses_id_key_when_at_id_missing(self):
        manifest = {
            "sequences": [{
                "canvases": [{
                    "images": [{
...
class TestExtractImageServiceBasesV3:
    ...
    def test_extracts_from_v3_manifest(self, sample_iiif_manifest_v3):
        bases = extract_image_service_bases(sample_iiif_manifest_v3)
        assert bases == ["https://example.org/iiif/img1"]

    def test_v3_body_as_list(self):
    ...
    def test_v3_service_as_dict(self):
    ...
    def test_v3_fallback_from_body_id(self):
    ...
    def test_v3_skips_empty_annotation_pages(self):
        manifest = {
            "items": [{
                "items": []
            }]
    ...
    def test_v3_skips_empty_annotations(self):
        manifest = {
            "items": [{
                "items": [{
                    "items": []
...
class TestExtractImageServiceBasesMixed:
    ...
    def test_both_v2_and_v3_deduped(self):
        manifest = {
            "sequences": [{
                "canvases": [{
                    "images": [{
...
class TestExtractDirectImageUrls:
    ...
    def test_extracts_v2_image_urls(self):
        manifest = {
            "sequences": [{
                "canvases": [
    ...
    def test_extracts_v3_image_urls(self):
        manifest = {
            "items": [{
                "items": [{
                    "items": [{
    ...
    def test_skips_canvases_without_images(self):
...
class TestImageUrlCandidates:
    ...
    def test_basic_candidates_without_info(self):
...
class TestFetchInfoJson:
    ...
    @patch("api.iiif.make_request")
    def test_fetches_and_caches_info(self, mock_req):
    ...
    @patch("api.iiif.make_request")
    def test_returns_cached_result(self, mock_req):
...
class TestDownloadOneFromService:
    ...
    @patch("api.iiif.download_file")
    def test_succeeds_on_first_candidate(self, mock_dl):
    ...
    @patch("api.iiif._fetch_info_json")
    @patch("api.iiif.download_file")
    def test_falls_back_to_info_json(self, mock_dl, mock_info):
    ...
    @patch("api.iiif._fetch_info_json")
    @patch("api.iiif.download_file")
    def test_returns_false_when_all_fail(self, mock_dl, mock_info):
    ...
    @patch("api.iiif._fetch_info_json")
    @patch("api.iiif.download_file")
    def test_handles_info_json_failure(self, mock_dl, mock_info):
        mock_dl.return_value = None
    ...
    @patch("api.iiif._fetch_info_json")
    @patch("api.iiif.download_file")
    def test_handles_info_json_exception(self, mock_dl, mock_info):
        mock_dl.return_value = None
