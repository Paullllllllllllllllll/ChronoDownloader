...
class TestStateManagerInit:
    ...
    def test_init_with_explicit_state_file(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
...
class TestStateManagerMigration:
    ...
    def test_migrates_from_old_quota_file(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
    ...
    def test_migrates_from_old_queue_file(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
...
class TestStateManagerQuotas:
    ...
    def test_get_quota_returns_none_for_unknown(self, manager: Any) -> None:
        """get_quota returns None for unknown provider."""
        assert manager.get_quota("unknown_provider") is None

    def test_set_quota_stores_data(self, manager: Any) -> None:
    ...
    def test_set_quota_persists_to_file(self, manager: Any, temp_dir: str) -> None:
    ...
    def test_update_quotas_batch_update(self, manager: Any) -> None:
    ...
    def test_get_quotas_returns_shallow_copy(self, manager: Any) -> None:
...
class TestStateManagerPersistence:
    ...
    def test_force_save_writes_to_disk(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
    ...
    def test_save_includes_timestamp(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
    ...
    def test_handles_corrupt_state_file(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
...
class TestStateManagerThreadSafety:
    ...
    def test_concurrent_quota_updates(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
        ...
        def update_quota(provider_id: int) -> None:
            for i in range(10):
    ...
    def test_concurrent_deferred_item_operations(
        self, temp_dir: str, mock_config: dict[str, Any]
    ) -> None:
