    ...
    def test_finds_config_files(self, temp_dir: str) -> None:
        ...
        with patch.object(Path, "glob") as mock_glob:
            ...
            with patch.object(ConsoleUI, "prompt_select", return_value=config1_path):
                with patch("main.ui.interactive.get_config", return_value=config_data):
    ...
    def test_sets_environment_variable(self, temp_dir: str) -> None:
        ...
        with patch.object(Path, "glob", return_value=[Path(config_path)]):
            with patch.object(ConsoleUI, "prompt_select", return_value=config_path):
                with patch("main.ui.interactive.get_config", return_value={}):
...
class TestDisplayProviderStatus:
    ...
    def test_displays_enabled_providers(self, capsys: Any, sample_config: dict[str, Any]) -> None:
    ...
    def test_displays_quota_info(self, capsys: Any) -> None:
        ...
        with patch("main.ui.interactive.get_config", return_value=config_with_quota):
            with patch("main.ui.interactive.PROVIDERS", mock_providers):
                workflow.display_provider_status()
...
class TestDisplaySummary:
    ...
    def test_shows_config_file_in_summary(self, capsys: Any) -> None:
        ...
        with patch("main.ui.interactive.get_config", return_value={"providers": {}}):
            with patch("main.ui.interactive.get_stats", return_value={"total": 10, "pending": 5, "completed": 3, "failed": 2}):
    ...
    def test_shows_csv_stats_in_summary(self, capsys: Any) -> None:
        ...
        with patch("main.ui.interactive.get_config", return_value={"providers": {}}):
            with patch("main.ui.interactive.get_stats", return_value=stats):
                with patch.object(ConsoleUI, "prompt_yes_no", return_value=True):
...
class TestConfigWorkflowIntegration:
    ...
    def test_full_csv_workflow_simulation(self, temp_dir: str, sample_csv_file: str) -> None:
