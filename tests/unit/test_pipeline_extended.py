...
class TestGetSelectionConfigExtended:
    ...
    def test_applies_all_defaults(self, mock_cfg: MagicMock) -> None:
...
class TestProviderOrderExtended:
    ...
    def test_no_hierarchy_preserves_order(self) -> None:
    ...
    def test_appends_unlisted_providers(self) -> None:
        p1 = _make_provider_tuple("ia", "IA")
        p2 = _make_provider_tuple("mdz", "MDZ")
...
class TestFilterEnabledProvidersForKeysExtended:
    ...
    def test_keeps_provider_without_key_requirement(self) -> None:
...
class TestRunDownloadWithFallback:
    ...
    def test_successful_primary_download(self) -> None:
    ...
    def test_failed_primary_triggers_fallback(self) -> None:
    ...
    @patch("main.orchestration.pipeline.get_deferred_queue")
    def test_quota_deferred_exception(self, mock_queue: MagicMock) -> None:
    ...
    def test_download_all_strategy(self) -> None:
...
class TestExecuteDownload:
    ...
    @patch("main.orchestration.pipeline.update_index_csv")
    @patch("main.orchestration.pipeline.build_index_row")
    @patch("main.orchestration.pipeline.update_work_status")
    @patch("main.orchestration.pipeline._run_download_with_fallback")
...
class TestLoadEnabledApisExtended:
    ...
    def test_nonexistent_config_returns_default(self, tmp_path: Path) -> None:
