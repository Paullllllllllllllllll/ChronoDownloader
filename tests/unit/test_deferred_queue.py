...
class TestDeferredItem:
    ...
    def test_get_reset_datetime_parses_iso(self) -> None:
    ...
    def test_get_reset_datetime_returns_none_if_not_set(self) -> None:
    ...
    def test_is_ready_for_retry_true_when_past_reset(self) -> None:
    ...
    def test_is_ready_for_retry_false_when_future_reset(self) -> None:
    ...
    def test_is_ready_for_retry_false_when_completed(self) -> None:
    ...
    def test_seconds_until_ready_future(self) -> None:
    ...
    def test_seconds_until_ready_past(self) -> None:
...
class TestDeferredQueueOperations:
    ...
    def test_add_creates_item(self, queue: Any) -> None:
    ...
    def test_remove_returns_false_if_not_found(self, queue: Any) -> None:
    ...
    def test_get_returns_none_if_not_found(self, queue: Any) -> None:
...
class TestDeferredQueueStatusOperations:
    ...
    def test_mark_completed_returns_false_if_not_found(self, queue: Any) -> None:
...
class TestDeferredQueueIteration:
    ...
    def test_len_returns_count(self, queue: Any) -> None:
...
class TestGetDeferredQueue:
    ...
    def test_get_deferred_queue_returns_singleton(self) -> None:
