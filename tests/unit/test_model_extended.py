...
class TestResolveItemField:
    ...
    def test_searchresult_attr(self) -> None:
    ...
    def test_searchresult_default(self) -> None:
    ...
    def test_non_dict_non_sr(self) -> None:
...
class TestResolveItemId:
    ...
    def test_searchresult_source_id(self) -> None:
    ...
    def test_dict_first_match(self) -> None:
        data = {"ark_id": "ark:/123", "id": "id1"}
        assert resolve_item_id(data, "ark_id", "id") == "ark:/123"

    def test_dict_none_when_missing(self) -> None:
        assert resolve_item_id({}) is None

    def test_non_dict_returns_none(self) -> None:
        assert resolve_item_id("string") is None  # type: ignore[arg-type]

    def test_default_key_is_id(self) -> None:
        data = {"id": "val"}
