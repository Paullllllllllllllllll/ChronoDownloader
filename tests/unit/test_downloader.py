...
class TestCreateCliParser:
    ...
    def test_parser_accepts_csv_file(self) -> None:
    ...
    def test_parser_has_log_level_option(self) -> None:
    ...
    def test_parser_has_cli_flag(self) -> None:
        """Parser has --cli flag."""
        from main.cli import create_cli_parser
    ...
    def test_parser_has_quota_status_flag(self) -> None:
    ...
    def test_parser_has_cleanup_deferred_flag(self) -> None:
    ...
    def test_parser_accepts_provider_override_args(self) -> None:
    ...
    def test_parser_accepts_processing_scope_args(self) -> None:
    ...
    def test_parser_accepts_runtime_override_args(self) -> None:
...
class TestCliHelpers:
    ...
    def test_apply_runtime_config_overrides(self) -> None:
    ...
    def test_filter_pending_rows_new_failed_and_limit(self) -> None:
    ...
    def test_looks_like_cli_invocation(self) -> None:
...
class TestRunCli:
    ...
    def test_run_cli_exits_without_csv_file(
        ...
        with patch("main.cli.dispatch.pipeline") as mock_pipeline:
...
class TestShowQuotaStatus:
    ...
    def test_show_quota_status_prints_output(
        self, capsys: pytest.CaptureFixture[str]
    ) -> None:
        """show_quota_status prints quota information."""
        from main.cli.commands.quota import show_quota_status

        with patch("main.cli.commands.quota.get_quota_manager") as mock_qm:
    ...
    def test_show_quota_status_shows_provider_quotas(
        self, capsys: pytest.CaptureFixture[str]
    ) -> None:
    ...
    def test_show_quota_status_shows_exhausted(
        self, capsys: pytest.CaptureFixture[str]
    ) -> None:
...
class TestCleanupDeferredQueue:
    ...
    def test_cleanup_deferred_queue_clears_completed(
        self, capsys: pytest.CaptureFixture[str]
    ) -> None:
        """cleanup_deferred_queue removes completed items."""
        from main.cli.commands.quota import cleanup_deferred_queue
...
class TestMain:
    ...
    def test_main_handles_quota_status_flag(self) -> None:
...
class TestRunCliEdgeCases:
    ...
    def test_run_cli_handles_csv_validation_error(
        self, mock_args: argparse.Namespace, mock_config: dict[str, Any], temp_dir: str
    ) -> None:
