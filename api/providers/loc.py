...
def search_loc(
    ...
    # Prefer the Books collection endpoint first; fall back to the generic
    # search if needed
...
def download_loc_work(
    ...
    iiif_manifest_hint = resolve_item_field(
    ...
    if iiif_manifest_url:
        ...
        if isinstance(iiif_manifest_data, dict):
            ...
            try:
                ...
                logger.exception(
                    "LOC: error while downloading manifest renderings for %s", item_id
                )
            ...
            if service_bases:
                ...
                logger.info(
                    ...
                    "falling back to single image if available.",
                    item_id,
                )
        else:
